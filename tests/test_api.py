...
class TestFetchDocumentsList:
    ...
    def test_parameter_encoding_special_chars(self):
        ...
        with patch("urllib.request.urlopen") as mock_urlopen:
            ...
            assert (
                "test%2Bkey%26value%3D123" in called_url
                or "Subscription-Key=test%2Bkey%26value%3D123" in called_url
            )
    ...
    def test_response_body_matches_real_edinet_api_shape(self):
        ...
        for required_key in ("docID", "edinetCode", "docTypeCode", "submitDateTime", "filerName"):
    ...
    def test_filter_quarterly_earnings_season(self):
        ...
        docs = [
            # Q3 earnings filings - need edinetCode for filtering to work
            {
                ...
                "filerName": "Company A",
                "edinetCode": "E12345",
                "submitDateTime": "2025-02-14T15:00:00",
            },
            {
                "docID": "S100A002",
                "docTypeCode": "180",
                "filerName": "Company B",
                "edinetCode": "E12346",
                "submitDateTime": "2025-02-14T16:30:00",
            },
            # Regular filings
            {
                "docID": "S100A003",
                ...
                "filerName": "Company C",
                "edinetCode": "E12347",
                "submitDateTime": "2025-02-14T10:00:00",
            },
        ]

        earnings_types = filter_documents(
            docs, doc_type_codes=["160", "180"], require_sec_code=False
        )
    ...
    def test_filter_by_industry_sector(self):
        ...
        docs = [
            ...
            },
            {
                "docID": "S100A002",
                "docTypeCode": "160",
                "filerName": "Sony Group Corporation",
                "industry": "Technology",
            },
            {
                "docID": "S100A003",
                "docTypeCode": "160",
                "filerName": "Mitsubishi UFJ Bank",
                "industry": "Financial",
            },
        ]
...
class TestDownloadDocuments:
    ...
    def test_handle_problematic_filer_names(self):
        ...
        with (
            patch("edinet_tools.api.fetch_document") as mock_fetch,
