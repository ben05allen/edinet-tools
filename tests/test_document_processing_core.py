...
from edinet_tools.processors import process_raw_csv_data
...
class TestCriticalDocumentTypes:
        ...
        self.type_140_csv_data = [
            {
                ...
                "data": [
                    ...
                    {
                        "要素ID": "jpcrp_cor:InternalControlReportTextBlock",
                        "項目名": "Internal Control Report",
                        "値": "当社の内部統制システムについて報告いたします。経営陣は財務報告に係る内部統制の整備及び運用状況について評価を行いました。",
                    },
                    {
                        "要素ID": "jpcrp_cor:CompanyNameCoverPage",
                        "項目名": "Company Name",
                        "値": "TOYOTA MOTOR CORPORATION",
                    },
                ],
            }
        ]
        ...
        self.type_160_csv_data = [
            {
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "項目名": "Net Sales",
                        "コンテキストID": "CurrentPeriod",
                        "値": "6508643",
                    },
                    {
                        "要素ID": "jpcrp_cor:NetSales",
                        "項目名": "Net Sales",
                        "コンテキストID": "PriorPeriod",
                        "値": "5972403",
                    },
                    {
        ...
        self.type_180_csv_data = [
            {
                ...
                "data": [
                    ...
                    {
                        "要素ID": "jpcrp_cor:ReasonForSubmissionSummaryTextBlock",
        ...
        for csv_data, doc_type, expected_terms in test_cases:
            ...
            for term in expected_terms:
                assert term in all_text, (
                    f"Japanese term '{term}' was lost in document type {doc_type}"
                )
    ...
    def test_empty_document_handling(self):
        ...
        empty_data = [{"filename": "empty.csv", "data": []}]
        ...
        type_180_realistic = [
            {
                ...
                "data": [
                    ...
                    },
                    {
                        ...
                        "項目名": "取締役会決議",
                        "値": "2025年6月1日開催の取締役会において、子会社株式の取得を決議いたしました。",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "項目名": "業績に与える影響",
                        "値": "当社の連結業績に与える影響は軽微であります。",
                    },
                    {
                        "要素ID": "jpcrp-esr_cor:SummaryOfReasonForSubmissionDescription",
                        "項目名": "提出理由の概要",
                        "値": "当社は、本日、A社の株式を取得し子会社化することを決議いたしました。",
                    },
                    # Noise: '－' null marker
