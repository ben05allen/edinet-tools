...
@pytest.mark.parametrize('method_name,expected_replacement_keyword', [
...
def test_method_emits_deprecation_warning_with_replacement(client, method_name, expected_replacement_keyword):
