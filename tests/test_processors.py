...
class TestBaseDocumentProcessor:
    ...
    def setup_method(self):
        ...
        self.mock_csv_data = [
            {
                ...
                "data": [
                    ...
                    {
                        "要素ID": "jpdei_cor:FilerNameInJapaneseDEI",
                        "項目名": "会社名",
                        "値": "テスト株式会社",
                    },
                    {
                        "要素ID": "jpcrp_cor:BusinessResultsTextBlock",
                        "項目名": "Business Results",
                        "値": "Test business content",
                    },
                    {
        ...
        self.processor = BaseDocumentProcessor(
            self.mock_csv_data, doc_id="TEST001", doc_type_code="120"
        )
    ...
    def test_get_value_by_id(self):
        ...
        current_sales = self.processor.get_value_by_id(
            "jpcrp_cor:NetSales", context_filter="Current"
        )
...
class TestSecuritiesReportProcessor:
    ...
    def setup_method(self):
        ...
        self.mock_csv_data = [
            {
                ...
                "data": [
                    ...
                    {"要素ID": "jpdei_cor:EDINETCodeDEI", "項目名": "EDINET Code", "値": "E02144"},
                    {
                        "要素ID": "jpdei_cor:FilerNameInEnglishDEI",
                        "項目名": "Company Name EN",
                        "値": "Test Corporation",
                    },
                    {
                        "要素ID": "jpdei_cor:DocumentTypeDEI",
                        "項目名": "Document Type",
                        "値": "Securities Report",
                    },
                    # Financial metrics
                    ...
                    {
                        "要素ID": "jpcrp_cor:OperatingIncome",
                        "項目名": "Operating Income",
                        "コンテキストID": "CurrentYear",
                        "値": "500000",
                    },
                    {"要素ID": "jpcrp_cor:TotalAssets", "項目名": "Total Assets", "値": "10000000"},
                    {
                        "要素ID": "jpcrp_cor:BasicEarningsLossPerShare",
                        "項目名": "EPS",
                        "値": "120.50",
                    },
                    ...
                    {
                        "要素ID": "jpcrp_cor:AverageAnnualSalary",
                        "項目名": "Average Salary",
                        "値": "7000000",
                    },
                    # Text blocks
                    {
                        ...
                        "項目名": "Management Analysis",
                        "値": "Management discusses financial position and results...",
                    },
                    {
                        "要素ID": "jpcrp_cor:RiskFactorsTextBlock",
                        "項目名": "Risk Factors",
                        "値": "Key business risks include market volatility...",
                    },
                    {
                        "要素ID": "jpcrp_cor:CorporateGovernanceTextBlock",
                        "項目名": "Corporate Governance",
                        "値": "Our corporate governance framework...",
                    },
                ],
            }
        ]
        ...
        self.processor = SecuritiesReportProcessor(
            self.mock_csv_data, doc_id="S100TEST1", doc_type_code="120"
        )
    ...
    def test_categorize_element(self):
        ...
        assert (
            self.processor._categorize_element("jpcrp_cor:RiskFactorsTextBlock") == "risk_factors"
        )  # 'risk' keyword
        assert (
            self.processor._categorize_element("jpcrp_cor:ManagementAnalysisTextBlock")
            == "management_analysis"
        )
        assert (
            self.processor._categorize_element("jpcrp_cor:CorporateGovernanceTextBlock")
            == "corporate_governance"
        )
        assert (
            self.processor._categorize_element("jpcrp_cor:ShareholderInformationTextBlock")
...
class TestInternalControlReportProcessor:
    ...
    def setup_method(self):
        ...
        self.mock_csv_data = [
            {
                ...
                "data": [
                    ...
                    {"要素ID": "jpdei_cor:EDINETCodeDEI", "項目名": "EDINET Code", "値": "E02126"},
                    {
                        "要素ID": "jpdei_cor:FilerNameInEnglishDEI",
                        "項目名": "Company Name",
                        "値": "Internal Control Test Co.",
                    },
                    # Internal control specific elements
                    {
                        "要素ID": "jpcrp_cor:InternalControlAssessmentResult",
                        "項目名": "Assessment Result",
                        "値": "Effective",
                    },
                    {
                        "要素ID": "jpcrp_cor:MaterialWeaknessInInternalControl",
                        "項目名": "Material Weakness",
                        "値": "None identified",
                    },
                    # Text blocks
                    {
                        "要素ID": "jpcrp_cor:InternalControlFrameworkTextBlock",
                        "項目名": "Internal Control Framework",
                        "値": "Our internal control framework is based on...",
                    },
                    {
                        "要素ID": "jpcrp_cor:EvaluationScopeTextBlock",
                        "項目名": "Evaluation Scope",
                        "値": "The evaluation covered company and subsidiaries...",
                    },
                ],
            }
        ]
        ...
        self.processor = InternalControlReportProcessor(
            self.mock_csv_data, doc_id="S100IC01", doc_type_code="235"
        )
...
class TestExtraordinaryReportProcessor:
    ...
    def setup_method(self):
        ...
        self.mock_csv_data = [
            {
                ...
                "data": [
                    ...
                    # Extraordinary report specific elements
                    {
                        ...
                        "項目名": "Board Resolution",
                        "値": "Board resolved to acquire subsidiary...",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "項目名": "Business Impact",
                        "値": "Expected to increase revenue by 10%...",
                    },
                    # Text blocks
                    {
                        "要素ID": "jpcrp_cor:SubmissionReasonTextBlock",
                        "項目名": "Submission Reason",
                        "値": "Filing due to material acquisition...",
                    },
                ],
            }
        ]
        ...
        self.processor = ExtraordinaryReportProcessor(
            self.mock_csv_data, doc_id="S100ER01", doc_type_code="180"
        )
...
class TestProcessorDispatcher:
    ...
    def test_process_raw_csv_data_internal_control(self):
        ...
        with patch(
            "edinet_tools.processors.InternalControlReportProcessor"
        ) as mock_processor_class:
            mock_instance = Mock()
            mock_instance.process.return_value = {"control": "data"}
            mock_processor_class.return_value = mock_instance
            mock_processor_class.__name__ = (
                "InternalControlReportProcessor"  # Fix __name__ attribute
            )
        ...
        return [
            {
                ...
                "data": [
                    ...
                    {
                        "要素ID": "jpcrp_cor:DividendPerShare",
                        "項目名": "配当",
                        "コンテキストID": "CurrentYearDuration",
                        "値": "－",
                    },
                    ...
                    # TextBlock rows mixed in:
                    {
                        "要素ID": "jpcrp_cor:ManagementAnalysisOfFinancialPositionOperatingResultsAndCashFlowsTextBlock",
                        "項目名": "MD&A",
                        "値": "当連結会計年度の業績について報告します。売上高は前年比増加しました。",
                    },
                    {
                        "要素ID": "jpcrp_cor:RiskFactorsTextBlock",
                        "項目名": "リスク要因",
                    ...
                    {
                        "要素ID": "jpcrp_cor:ShareholderInformationTextBlock",
                        "項目名": "株主情報",
                        "値": "当社の主要株主は以下の通りです。",
                    },
                    # NonConsolidatedMember disambiguator:
                    {
                        "要素ID": "jpcrp_cor:BookValuePerShare",
                        "項目名": "1株当たり純資産",
                    ...
                    {
                        "要素ID": "jpcrp_cor:SomeUnmappedTextBlock",
                        "項目名": "unmapped",
                        "値": None,
                    },  # None value should be filtered from text_blocks
                    {
                        "要素ID": "jpcrp_cor:UnmappedFactNotInProcessorMap",
                        "項目名": "何か",
                        "値": "ignored-by-processor",
                    },
                    {
...
if __name__ == "__main__":
    ...
    try:
        ...
        mock_data = [
            {
                "filename": "test.csv",
                "data": [{"要素ID": "test:element", "項目名": "Test", "値": "value"}],
            }
        ]
