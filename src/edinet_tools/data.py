...
class CompanyLookup:
    ...
    def ticker_to_edinet(self, ticker: str) -> str | None:
    ...
    def edinet_to_ticker_code(self, edinet_code: str) -> str | None:
        """Convert EDINET code to ticker symbol."""
        return self.edinet_to_ticker_map.get(edinet_code)

    def resolve_company_identifier(self, identifier: str) -> str | None:
        """
...
def ticker_to_edinet(ticker: str) -> str | None:
    """Convert ticker symbol to EDINET code."""
    return _get_company_lookup().ticker_to_edinet(ticker)


def resolve_company(identifier: str) -> str | None:
...
def get_company_info(edinet_code: str) -> dict[str, Any] | None:
    """Get company information by EDINET code."""
