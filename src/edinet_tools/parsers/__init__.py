...
_SUPPORTED_CODES: frozenset[str] = frozenset(
    {
        ...
        "010",
        "020",  # Securities notification
        "030",
        "040",
        "050",  # Securities registration
        "060",  # Issuance notification
        "070",
        "080",
        "090",  # Shelf registration
        "100",  # Issuance supplementary
        "110",  # Issuance withdrawal
        # === Securities reports family (120-170) ===
        "120",
        "130",  # Securities report + amendment
        "135",
        "136",  # Confirmation document + amendment
        "140",
        "150",  # Quarterly report + amendment
        "160",
        "170",  # Semi-annual report + amendment
        # === Extraordinary / treasury / internal control / tender offer family (180-340) ===
        "180",
        "190",  # Extraordinary report + amendment
        "200",
        "210",  # Parent company status report + amendment
        "220",
        "230",  # Treasury stock + amendment
        "235",
        "236",  # Internal control report + amendment
        "240",
        "250",  # Tender offer registration + amendment
        "260",  # Tender offer withdrawal
        "270",
        "280",  # Tender offer report + amendment
        "290",
        "300",  # Opinion report + amendment
        "310",
        "320",  # Question response + amendment
        "330",
        "340",  # Exemption application + amendment
        # === Large shareholding family (350-380) ===
        "350",
        "360",  # Large shareholding + amendment
        "370",
        "380",  # Large shareholding change + amendment
    }
)
