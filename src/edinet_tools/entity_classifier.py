...
class EntityClassifier:
    ...
    def __init__(self, edinet_codes_path: str | None = None, fund_codes_path: str | None = None):
        """
    ...
    def data_version(self) -> dict:
        ...
        return {"edinet_codes": self.edinet_codes_date, "fund_codes": self.fund_codes_date}
